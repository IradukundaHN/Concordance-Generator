...
public class ConcordanceDataManagerTest {
	...
	private File inputFile, outputFile, inputFileSTUDENT,outputFileSTUDENT;
	private String text;
	...
	public void testCreateConcordanceFileSTUDENT() {
		...
		try {
			...
			inFile.print("Of course the student test created\n" +
					"should pass\n" +
					"at all for no reason\n" +
					"in this project\n");
			
			inFile.close();
			outputFileSTUDENT = new File("Test1Out.txt");
			PrintWriter outFile = new PrintWriter(outputFile);
			outFile.print(" ");
			...
			assertEquals("all: 3", wordsSTUDENT.get(0));
			assertEquals( "pass: 2", wordsSTUDENT.get(1));
			assertEquals("reason: 3", wordsSTUDENT.get(2));
			assertEquals("project: 4", wordsSTUDENT.get(3));
			assertEquals("should: 2", wordsSTUDENT.get(4));
			assertEquals("pass: 2", wordsSTUDENT.get(5));
			assertEquals("created: 1", wordsSTUDENT.get(6));
			assertEquals("student: 1", wordsSTUDENT.get(7));
			assertEquals("this: 4", wordsSTUDENT.get(8));
			assertEquals("course: 1", wordsSTUDENT.get(9));
		} catch (FileNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (Exception e) {
